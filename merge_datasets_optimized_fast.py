...
def load_simplified_nq(filepath: str) -> dict:
    ...
    try:
        with open(filepath, 'r', encoding='utf-8') as f:
            ...
            pbar = tqdm(desc="Loading simplified NQ", unit=" questions")
...
def main():
    ...
    # Пути к файлам
    simplified_nq = 'simplified_qa/simplified-nq-dev.jsonl'
    ...
    # Загружаем данные из simplified NQ
    logging.info("Loading simplified NQ dataset...")
    simplified_nq_data = load_simplified_nq(simplified_nq)
    if not simplified_nq_data:
        logging.error("Failed to load simplified NQ dataset")
        return
